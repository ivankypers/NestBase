...
export class Initial1715889773417 implements MigrationInterface {
  name = 'Initial1715889773417';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "players_trainers" ("trainer_id" integer NOT NULL, "player_id" integer NOT NULL, CONSTRAINT "PK_472a349d435660dc793d23774b3" PRIMARY KEY ("trainer_id", "player_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "players_matches" ("player_id" integer NOT NULL, "match_id" integer NOT NULL, CONSTRAINT "PK_b824cc821a296f87adc007ae094" PRIMARY KEY ("player_id", "match_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "players_trainers" ADD CONSTRAINT "FK_60d9f98a7dbde64a93305e76265" FOREIGN KEY ("trainer_id") REFERENCES "trainers"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "players_trainers" ADD CONSTRAINT "FK_7726d880a7c9205bd446598d319" FOREIGN KEY ("player_id") REFERENCES "players"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "players_matches" ADD CONSTRAINT "FK_7018d38352a85427436ebd492de" FOREIGN KEY ("player_id") REFERENCES "players"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "players_matches" ADD CONSTRAINT "FK_4e497e4d9bec9f5fd10270b1ea0" FOREIGN KEY ("match_id") REFERENCES "matches"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
